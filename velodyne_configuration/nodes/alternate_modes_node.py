...
class ConfiguratorNode:
    def __init__(self):
        ...
        self._special_config_srv_proxy = rospy.ServiceProxy('/sensor/lidar/vls128_roof/special_commands',
        ...
        rospy.wait_for_service('/sensor/lidar/vls128_roof/special_commands')
